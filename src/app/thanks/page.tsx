    ...
    <div className="min-h-screen flex flex-col bg-white text-zinc-950">
      ...
      <section className="flex-1">
        <div className="max-w-3xl mx-auto px-6 lg:px-10 pt-20 sm:pt-28 pb-20">
          ...
          <h1 className="text-[44px] sm:text-[64px] font-medium leading-[0.95] tracking-[-0.04em] text-zinc-950 mb-8">
          ...
          <div className="space-y-6 text-zinc-700">
            {email && (
              <p>
                Une license <strong className="text-zinc-950 font-medium">Studio Edition</strong>{" "}
                te sera envoyée à{" "}
                <strong className="text-zinc-950 font-medium">{email}</strong>{" "}
          ...
          <div className="mt-12 pt-12 border-t border-zinc-200">
            ...
            <ol className="space-y-5 text-zinc-700">
              <Step
                n="01"
  ...
  return (
    <li className="grid grid-cols-12 gap-4">
      ...
      <div className="col-span-10 sm:col-span-11">
        <h4 className="text-base font-medium text-zinc-950 mb-1">{title}</h4>
